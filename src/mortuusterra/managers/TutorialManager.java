...
public class TutorialManager {
	...
	public void showZombies1(Player player) {
		...
		player.sendMessage(
				ChatColor.AQUA + "Tutorial" + ChatColor.WHITE + "Zombies " + ChatColor.GRAY + "(if installed)");
	...
	public void showVampires1(Player player) {
		...
		player.sendMessage(
				ChatColor.AQUA + "Tutorial" + ChatColor.WHITE + "Vampires " + ChatColor.GRAY + "(if installed)");
	...
	public void showElectricity(Player player) {
		...
		player.sendMessage(
				ChatColor.AQUA + "Tutorial" + ChatColor.WHITE + "Electricity " + ChatColor.GRAY + "(if installed)");
	...
	public void showCommunication(Player player) {
		...
		player.sendMessage(
				ChatColor.AQUA + "Tutorial" + ChatColor.WHITE + "Communication " + ChatColor.GRAY + "(if installed)");
